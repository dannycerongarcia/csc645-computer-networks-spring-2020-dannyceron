...
class Client(object):
    ...
    def __init__(self):
        ...
        self.client_id = None
        self.student_name = "Danny Daneth Ceron Garcia" # TODO: your name
        self.github_username = "dannyceron94" # TODO: your username
        self.sid = 918581149 # TODO: your student id
    ...
    def connect(self, server_ip_address, server_port):
        ...
        # self.bind(server_ip_address,server_port)
